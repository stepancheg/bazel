...
public class BcInstr {
  ...
  public static final int NULL_REG = Integer.MIN_VALUE;

  /** Constants are stored in a separate array. Constant slots are negative integers. */
  public static int constSlotToArrayIndex(int slot) {
  ...
  public static final int IF_BR = 6;
  public static final int IF_NOT_BR = 7;
  public static final int BINARY = 8;
  public static final int BINARY_IN_PLACE = 9;
  public static final int GET_LOCAL = 10;
  public static final int GET_GLOBAL = 11;
  public static final int GET_PREDECLARED = 12;
  public static final int GET_LEGACY = 13;
  public static final int SET_LOCAL = 14;
  public static final int SET_GLOBAL = 15;
  public static final int SET_LEGACY = 16;
  public static final int DOT = 17;
  public static final int INDEX = 18;
  public static final int SLICE = 19;
  public static final int CALL = 20;
  public static final int RETURN = 21;
  public static final int RETURN_NONE = 22;
  ...
  public static final int STMT = 29;
  public static final int SAVE_LOCALS = 30;
  public static final int RESTORE_LOCALS = 31;
  public static final int LIST_APPEND = 32;
  public static final int SET_INDEX = 33;
  public static final int EVAL_EXCEPTION = 34;
  public static final int UNPACK = 35;
  public static final int DBG = 36;
